...
public class DeleteSelectionAction extends DocumentAction {

  public DeleteSelectionAction(JFrame parent, MultipleDocumentModel model, String key, ILocalizationProvider lp) {
